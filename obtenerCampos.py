...
def camposValor(lineas):
    #[dbo].[Adjuntos]
    sql_sentence = "INSERT [dbo] ([id], [Solicitudes_id], [nombreArchivo], [envioID], [usuario], [fecha]) VALUES (9978, 1848, 'Observaciones_SES_1848.pdf', 'p1flp5sger16t11mtef3hovj1vr67', 'pku-consultor@aig.gob.pa', CAST('2021-11-30T14:42:58.000' AS DateTime))"

    # field_names = re.findall(r'\[([^\]]+)\]', sql_sentence)
    # Extract field names using regex
    field_values = re.findall(r"INSERT.\[dbo\] \((.*?)\)", sql_sentence, re.DOTALL)
    print(field_values)
